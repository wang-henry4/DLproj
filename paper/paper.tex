...
\begin{figure}[ht]
    ...
    \end{subfigure}
    \caption{Results of models on training data set. Model1 represents the pretrained model with the earliest layer, Model2 with the second earliest layer and so on.}
  \end{figure}
...
{\raggedright Table 1: Results of models on test set. Model1 represents the pre-trained model with the earliest layer, Model2 with the second earliest layer and so on. \par}
